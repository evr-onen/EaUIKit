  ...
  >
    ...
    >
      ...
      <div class="ea-message__icon" v-if="showIcon">
        <MessageSuccess v-if="type === 'success'" class="size-8" />
        <MessageError v-if="type === 'error'" class="size-8" />
        <MessageInfo v-if="type === 'info'" class="size-8" />
        <MessageWarning v-if="type === 'warning'" class="size-8" />
      </div>
...
import MessageSuccess from '@/assets/icons/message-success.vue'
import MessageError from '@/assets/icons/message-error.vue'
import MessageInfo from '@/assets/icons/message-info.vue'
import MessageWarning from '@/assets/icons/message-warning.vue'
